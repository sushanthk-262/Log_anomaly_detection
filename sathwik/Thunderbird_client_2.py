...
model_folder = "Thunderbird_bert_model"
pickle_file = "pickle_Thunderbird_bert_model.pickle"

# Load your dataset
df = pd.read_csv('Thunderbird_sequence.csv', sep=',', quotechar='"', names=["text", "label"])
df = df[1:200]
...
# # Load custom dataset for client 2
...
#         # Perform training on client 2 with its data
#         r = model.fit(x_train, y_train, epochs=1, verbose=0)
#         hist = r.history
#         print("Client 2 Fit history: ", hist)
#         return model.get_weights(), len(x_train), {}

#     def evaluate(self, parameters, config):
#         model.set_weights(parameters)
#         # Perform evaluation on client 2 with its data
#         loss, accuracy = model.evaluate(x_train, y_train, verbose=0)
#         print("Client 2 Eval accuracy: ", accuracy)
#         return loss, len(x_train), {"accuracy": accuracy}

# # Start Flower client 2
# fl.client.start_numpy_client(
